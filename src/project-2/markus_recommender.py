...
class Group4Recommender:
    ...
    def __init__(self, n_actions, n_outcomes):
        ...
        self.policy_model = linear_model.LogisticRegressionClassifer()
        self.outcome_guesser = linear_model.LogisticRegressionClassifer()
    ...
    def fit_treatment_outcome(self, data, actions, outcome):
        ...
        self.classifier.fit(np.hstack((data, actions)))
    ...
    ##
    ## If a policy is given, then you can either use impor  tanceoutcomes
